            ...
            <table style="width: 90%; margin: auto">
                ...
                <tbody>
                    ...
                    while ($row = $podaci->fetch_array()) {
                        ...
                        echo "<td>$row[1]</td>";
                        echo "<td>$row[13]</td>";
                        echo "<td style=\"width: 80px; text-align: center; color: green\">$row[8]</td>";
                        echo "<td style=\"width: 80px; text-align: center; color: red\">$row[9]</td>";                        
                        echo "<td style=\"width: 80px; text-align: center; color: green\">$row[10]</td>";
                        echo "<td style=\"width: 80px; text-align: center; color: red\">$row[11]</td>";
                        echo '</tr>';
                        $brojac++;
                    }
                    ?>
